...
Our teamwork and communication went really well this week. We worked effectively as a team, with two members focusing on the backend and two members focusing on the frontend.

### 2. What were some challenges your group faced in this unit?

One challenge we faced was scheduling. Some team members had conflicts at times, so only two or three of us could attend certain meetings, but we communicated well and worked through it together.

### 3. What were some of the highlights or achievements that you are most proud of in this project?

One of our biggest achievements was successfully deploying the project and merging the frontend and backend into the main branch without major merge conflicts.

### 4. Reflecting on your web development journey so far, how have you grown since the beginning of the course?
Tony - I learned a lot in both frontend and backend development, and I have improved at debugging and understanding the code I write.

### 5. Looking ahead, what are your goals related to web development, and what steps do you plan to take to achieve them?
tONY - My goal is to build a project that uses AI, and I plan to take an AI course to gain the skills I need.
